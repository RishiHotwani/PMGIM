  ...
  try {
    ...
    if (exploreRows[0].count === 0) {
      const places = [
        ...
        ['Lamgau Rock-Cut Caves (Bicholim)', 'Shopping', 4.7, '8 km · 15 min scooter', 'Free Entry', 'https://images.unsplash.com/photo-1564507592333-c60657eea523?auto=format&fit=crop&w=800&q=80', false, 'Hidden 5th-century rock-cut Buddhist & Hindu caves in dense areca nut plantations near Bicholim.', 'https://www.google.com/maps/search/?api=1&query=Lamgau+Caves+Bicholim+Goa', '9:00 AM – 5:00 PM', 'Free Entry', 'Short scenic trek through Goan palm groves.'],
...
function seedMemoryData() {
  ...
  memoryStore.explore_places = [
    ...
    { id: 25, name: 'Lamgau Rock-Cut Caves (Bicholim)', category: 'Shopping', rating: 4.7, distance: '8 km · 15 min scooter', price: 'Free Entry', image: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?auto=format&fit=crop&w=800&q=80', is_bookmarked: false, description: 'Hidden 5th-century rock-cut Buddhist & Hindu caves near campus.', maps_url: 'https://www.google.com/maps/search/?api=1&query=Lamgau+Caves+Bicholim+Goa', best_time: '9:00 AM – 5:00 PM', est_cost: 'Free Entry', pro_tips: 'Short scenic trek through Goan palm groves.' },
